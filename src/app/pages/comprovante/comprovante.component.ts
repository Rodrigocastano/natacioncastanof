// src/app/pages/comprovante/comprovante.component.ts
import { Component, OnInit } from '@angular/core';
import { CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms';
import { CalendarModule } from 'primeng/calendar';
import { DropdownModule } from 'primeng/dropdown';          // ⬅️ NUEVO
...
/* import { Usuario } from '../service/comprovante.service'; */   // ⬅️ Interface del usuario
...
export class ComprovanteComponent implements OnInit {
  ...
  usuarios: any[] = [];            // recarga desde el servicio
  usuarioSel: any | null = null;   // usuario seleccionado en el dropdown
  ...
  /* Buscar */
  buscarPagos(): void {
    if (!this.fechaInicio || !this.fechaFin || !this.usuarioSel) return;

    const inicio = this.firstDay(this.fechaInicio);
    const fin    = this.lastDay(this.fechaFin);

    this.comproService
        .getPagosPorUsuario(inicio, fin, this.usuarioSel.id)
        .subscribe({
