...
@Component({
  selector: 'app-plan-pago-entrenador',
   imports: [
    CommonModule,
    ButtonModule,
    ToolbarModule,
  ...
  templateUrl: './plan-pago-entrenador.component.html'
})
export class PlanPagoEntrenadorComponent implements OnInit{
  
      formSave!: FormGroup;
      visibleSave: boolean = false;
      planPago: PlanPagoEntrenador[] = [];
      idPago: number = 0;
      ...
      buscarOriginal: PlanPagoEntrenador[] = [];
      opcionesDiass: any[] = [];
