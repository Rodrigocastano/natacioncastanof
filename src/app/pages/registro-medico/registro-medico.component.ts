...
import { registroMedicos } from '../../../app/pages/interfaces/medico';
...
export class RegistroMedicoComponent implements OnInit {
      ...
      submitted = false;
      filtro = '';
      buscadorFiltrados: registroMedicos[] = [];
      genero: Genero[] = [];
      ciudad: Ciudad[] = [];
      user: any
      ...
      constructor(
        ...
        getMedicos() {
          this.medicoService.getRegistroMedicos().subscribe(data => {
            this.medicos = data;
        ...
        store() {
          ...
          if (this.formSave.valid) {
            ...
            this.medicoService.createRegistroMedicos(newEntrenador).subscribe({
              next: () => {
        ...
        buscador() {
          ...
          if (termino === '') {
          this.medicos = [...this.buscadorFiltrados];
          } else {
          this.medicos = this.buscadorFiltrados.filter(user =>
        ...
        update() {
          ...
          const updateUsuario: registroMedicos = {
            id: this.idForUpdate,
          ...
          this.medicoService.updateRegistroMedicos(this.idForUpdate, updateUsuario).subscribe({
            next: () => {
              this.saveMessageToast(); 
              this.getMedicos();
        ...
        edit(id: number) {
          ...
          this.idForUpdate = id;
          this.user = this.medicos.find(e => e.id == id);
        ...
        delete() {
          this.medicoService.deleteRegistroMedicos(this.idMedico).subscribe({
            next: () => {
        ...
        exportPdf() {
          ...
          doc.text('Listado de médico', marginL + 60, 30);
        
          const data = [...this.medicos]
